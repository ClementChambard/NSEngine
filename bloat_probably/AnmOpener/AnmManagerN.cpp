...
namespace NSEngine {
    ...
    void AnmManagerN::drawSprite(size_t slot, size_t& spriteID)
    {
        ...
        draw_quad_tex_2d(TextureManager::GetTextureID(s.texID), {-s.w/2.f, +s.h/2.f, u1, v1}, {+s.w/2.f, +s.h/2.f, u2, v1}, {+s.w/2.f, -s.h/2.f, u2, v2}, {-s.w/2.f, -s.h/2.f, u1, v2});
    }
    ...
    void AnmManagerN::drawTexture(size_t slot, size_t& texID)
    {
        ...
        int w = 0, h = 0;
        TextureManager::GetTextureSize(tex, w, h);
        draw_quad_tex_2d(TextureManager::GetTextureID(tex), {-w/2.f, +h/2.f, 0.f, 0.f}, {+w/2.f, +h/2.f, 1.f, 0.f}, {+w/2.f, -h/2.f, 1.f, 1.f}, {-w/2.f, -h/2.f, 0.f, 1.f});
    }
