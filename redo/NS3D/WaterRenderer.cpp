...
WaterRenderer::WaterRenderer(WaterShader* shad) : shader(shad)
{
    ...
    shader->stop();
    dudvMapTexID = ns::ImageLoader::loadTexture("assets/engine/textures/waterDudvMap.png").id;
    normalMapTexID = ns::ImageLoader::loadTexture("assets/engine/textures/waterNormalMap.png").id;
}
...
{
    static f32 mvFact1 = 0.f, mvFact2 = 0.f;
    ...
    shader->SetCameraPosition(ns::activeCamera3D()->getPosition());
