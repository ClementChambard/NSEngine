...
struct Vertex {
    ...
    Vertex(const glm::vec3& p, u8 r, u8 g, u8 b, u8 a, f32 u, f32 v)
    {
        position = p;
        color = Color(r, g, b, a);
        uv = glm::vec2(u, v);
    ...
    Vertex(f32 x, f32 y, f32 z, u8 r, u8 g, u8 b, u8 a, const glm::vec2& u)
    {
        position = glm::vec3(x, y, z);
        color = Color(r, g, b, a);
        uv = u;
    }
    Vertex(const glm::vec3& p, const Color& c, f32 u, f32 v)
    {
        position = p;
        color = c;
        uv = glm::vec2(u, v);
    }
    Vertex(const glm::vec3& p, u8 r, u8 g, u8 b, u8 a, const glm::vec2 u)
    {
        position = p;
        color = Color(r, g, b, a);
        uv = u;
    }
    Vertex(f32 x, f32 y, f32 z, const Color& c, const glm::vec2& u)
    {
        position = glm::vec3(x, y, z);
        color = c;
        uv = u;
