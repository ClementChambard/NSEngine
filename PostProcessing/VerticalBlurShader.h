#ifndef VERTICALBLURSHADER_INCLUDED_H
#define VERTICALBLURSHADER_INCLUDED_H
...
namespace NSEngine {
    ...
    class VerticalBlurShader : public ShaderProgram {
        public:
            VerticalBlurShader() : ShaderProgram(VERTEX_SHADER_PATH, FRAGMENT_SHADER_PATH) { bindAttributes(); getAllUniformLocation(); }
