#ifndef ANIMSHADERTWOCOLOR_INCLUDED_H
#define ANIMSHADERTWOCOLOR_INCLUDED_H
...
namespace NSEngine {
    ...
    class AnimShaderTwoColor : public ShaderProgram {
        public:
            AnimShaderTwoColor() : ShaderProgram(VERTEX_SHADER_PATH, FRAGMENT_SHADER_PATH) { bindAttributes(); getAllUniformLocation(); };
