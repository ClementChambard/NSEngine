#ifndef CSTES_HEADER_INCLUDED
#define CSTES_HEADER_INCLUDED

#define NS_INF 1e30
#define NS_FEPSILON 1.192092896e-07f
...
template <typename T> constexpr T PI_1_6 = 0.5235987755982988;
